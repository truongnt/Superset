...
const ID_CHOICES         = [['ma_don_vi','ma_don_vi'],['current_province_id','current_province_id'],['id','id'],['unit_id','unit_id']];
const CODE_CHOICES       = [['ma_tinh','ma_tinh'],['province_code','province_code'],['code','code']];
const DRILL_CODE_CHOICES = [['ma_xa','ma_xa'],['commune_code','commune_code'],['ward_code','ward_code'],['code','code']];
        ...
        [
          {
            ...
            config: {
              ...
              description: t('Khoá chính đơn vị — xã tham chiếu cột này qua ma_don_vi_cha để link về tỉnh cha'),
              default: 'ma_don_vi',
              freeForm: true,
              renderTrigger: false,
              choices: ID_CHOICES,
        ...
        [
          {
            ...
            config: {
              ...
              description: t('Cột mã xã trong dataset bản đồ — join với "Cột mã xã (drill down)"'),
              default: 'ma_xa',
              freeForm: true,
              renderTrigger: false,
